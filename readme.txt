...
The relational model is simplified. A relation is defined as a 2d-table, columns have names but not type.
Rows are not ordered (except with relOrder function) and do not have duplicates.
